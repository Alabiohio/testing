...
export default function BookedOrderPageClient() {
                    ...
                    <div className="space-y-6 lg:sticky lg:top-32">
                        <div className="bg-white rounded-xl md:rounded-3xl p-6 md:p-8 border border-earth/10 relative overflow-hidden">
                            ...
                            <button
                                ...
                                className={`w-full mt-10 px-6 py-5 rounded-xl font-bold uppercase tracking-[0.18em] transition-all text-sm ${
                                    isFormValid && !isSubmitting
                                        ? "bg-deep-green text-white hover:bg-[#0f2f21] shadow-sm"
