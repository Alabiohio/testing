        ...
        <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl p-4 shadow-[0_18px_40px_-30px_rgba(15,23,42,0.25)] border border-black/6 flex flex-col lg:flex-row items-center gap-4">
                ...
                <div className="relative flex-grow w-full lg:w-auto">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-4 py-3 bg-[#f4f5f1] rounded-xl outline-none focus:ring-2 focus:ring-deep-green/10 transition-all font-medium"
                    />
                </div>
                ...
                <div className="flex items-center gap-3 w-full lg:w-auto">
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-xl font-bold transition-all border ${isFilterOpen ? 'bg-deep-green text-white border-deep-green' : 'bg-white text-gray-700 border-black/8 hover:border-deep-green/20'}`}
                    >
                    ...
                    <div className="relative group flex-grow lg:flex-grow-0">
                        <select
                            ...
                            className="appearance-none w-full bg-[#f4f5f1] border border-transparent hover:border-black/8 px-6 py-2 pr-12 rounded-xl font-bold text-gray-700 outline-none cursor-pointer transition-all"
                        >
            ...
            <AnimatePresence>
                {isFilterOpen && (
                    ...
                    >
                        <div className="bg-white rounded-xl p-4 shadow-[0_18px_40px_-30px_rgba(15,23,42,0.25)] border border-black/6 grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
                            {/* Price Range */}
