                    ...
                    <div className="relative px-8 py-7 flex flex-col sm:flex-row items-center justify-between gap-5">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 shrink-0">
                            <a
                                ...
                                className="flex items-center gap-2 bg-white/8 hover:bg-white/12 border border-white/10 text-white px-5 py-2.5 rounded-md text-sm font-semibold transition-all duration-200 whitespace-nowrap"
                            >
                            ...
                            <a
                                ...
                                className="flex items-center gap-2 bg-[#2c5b43] hover:bg-[#214734] text-white px-5 py-2.5 rounded-md text-sm font-semibold transition-all duration-200 shadow-sm whitespace-nowrap"
                            >
                    ...
                    <div className="col-span-2 md:col-span-1">
                        ...
                        <form className="relative" onSubmit={(e) => e.preventDefault()}>
                            <input
                                ...
                                className="w-full bg-white/5 border border-white/10 rounded-md pl-4 pr-10 py-3 text-sm text-white placeholder-white/30 focus:outline-none focus:border-[#87a08e]/50 focus:bg-white/10 transition-all shadow-inner"
                            />
                            <button
                                type="submit"
                                className="absolute right-1.5 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center bg-[#2c5b43] hover:bg-[#214734] text-white rounded-md transition-colors cursor-pointer"
                            >
